...
M.options = {
  ...
  ---
  --- Works by wrapping `vim.lsp.handlers["$/progress"]` with Juu's logger.
  ...
  --- `$/progress` handler! It will conflict with the handler that Juu tries
...
---@see juu.progress.lsp.ProgressMessage
