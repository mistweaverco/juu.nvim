local Notification = require("juu.notify.service.notification")
local NotificationBuf = require("juu.notify.service.buffer")
local NotificationService = require("juu.notify.service")
local WindowAnimator = require("juu.notify.windows")
local config = require("juu.notify.config")
local stage_util = require("juu.notify.stages.util")
local stages = require("juu.notify.stages")
...
---@param n1 juu.notify.Notification
---@param n2 juu.notify.Notification
---@return boolean
...
---@param global_config juu.notify.Config
return function(user_config, inherit, global_config)
  ---@type juu.notify.Notification[]
  local notifications = {}
  ...
  local function get_render(render)
    ...
    return require("juu.notify.render")[render]
  end

  ---@param notif juu.notify.Notification
  ---@return juu.notify.Notification?
