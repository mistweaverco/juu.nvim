...
---@field on_open fun(win: number, record: juu.notify.Record) | nil
---@field on_close fun(win: number, record: juu.notify.Record) | nil
---@field render fun(buf: integer, notification: juu.notify.Notification, highlights: table<string, string>)
